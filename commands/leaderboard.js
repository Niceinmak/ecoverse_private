...
exports.execute = async (client, message, args) => {
    ...
    .setAuthor(`Sofiath Top 15 Liderler Sıralaması`, message.guild.iconURL)
        .setColor("RANDOM")
    ...
    leaderboard.forEach(u => {
        embed.addField(`${u.position}. ${client.users.cache.get(u.id) ? client.users.cache.get(u.id).tag : "Bilinmeyen#0000"}`, `${u.money} 💸`);
    });
